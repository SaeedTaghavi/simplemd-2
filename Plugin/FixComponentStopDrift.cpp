...
#include "Plugin/FixComponentStopDrift.hpp"
...
void
FixComponentStopDriftHelper::HookL2( Cell* cell )
{
	...
	//	cout << "FixComponentStopDriftHelper::HookL2 - " << compo << endl;
}


void
FixComponentStopDriftHelper::HookL0( SingleMolEntity* mol )
{
...
void
FixComponentStopDriftPlugin::ForceHook()
{
  //ここで、CollectorPluginを初期化し、使いすてる。
  FixComponentStopDriftHelper fixcomponenthelper( compo );
  //cout << ":" << id08 << ":" << endl;
...
void
FixComponentStopDriftPlugin::initialize( SimpleMD* sys )
{
  system = sys;
}
